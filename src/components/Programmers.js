...
export default function Programmers() {
  ...
  let [featuredProgrammer, setFeaturedProgrammer] = useState(null);
  ...
  const getNameOfFeatured = () => {
    ...
    return programmersList.find(programmer => programmer.id == featuredProgrammer).name
  };

  const style = {
    fontSize: '1.5em',
    marginTop: '0.5em',
    color: featuredProgrammer === null ? 'royalBlue' : 'yellow' // 🤔
  };
