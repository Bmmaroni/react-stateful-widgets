...
export default function Squares() {
  ...
  let [squaresOn, setSquaresOn] = useState(listOfSquareIds);
  let [activeSquareOn, setActiveSquareOn] = useState(listOfSquareIds);
  ...
  const getClassName = id => {
    ...
    return id === activeSquareOn ? 'active' : ''
  };
  ...
  const markActive = id => {
    ...
    activeSquareOn === id ? setActiveSquareOn('') : setActiveSquareOn(id)
  };
